...
void draw() { 
  ...
  if (perdeu){
    ...
    pointLight(255,255,255,int(x),int(y),int(20));
    esfera(x, y, 20, 10);
    ...
    cubo(0,20,0,height,0,20);
    cubo(0,width-30,0,20,0,20);
    cubo(0,width-30,height-20,height,0,20);
    cubo(width-30,width-20,mouseY-40,mouseY+40,0,20);
